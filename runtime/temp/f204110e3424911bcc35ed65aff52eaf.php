<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\tp\public/../application/admin/view/default/owner\index.html";i:1507451618;s:76:"D:\phpStudy\WWW\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $owner['name']; ?></a></td>
            <td><?php echo $owner['tel']; ?></td>
            <td><?php echo $owner['sex']; ?></td>
            <td><?php echo $owner['age']; ?></td>
            <td><?php echo $owner['card']; ?></td>
            <td><?php echo !empty($owner['status']) && $owner['status']==1?'通过':'未通过'; ?></td>

            <td>
                <a href="<?php echo url('setStatus?ids='.$owner['id'].'&status='.abs(1-$owner['status'])); ?>" class="ajax-get"><?php echo show_status_op($owner['status']); ?></a>
